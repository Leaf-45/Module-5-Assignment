...
{
    private final Map<String, Integer> firstNameCodeMap = new HashMap<>();
    private final Map<String, Integer> firstInitialCodeMap = new HashMap<>();
    private final Map<String, Integer> middleInitialCodeMap = new HashMap<>();
    ...
    {
        if (firstName.isEmpty()) throw new MissingNameException("first name");
        int firstCode = 0;
        if (firstNameCodeMap.containsKey(firstName.toUpperCase()))
        {
            firstCode = firstNameCodeMap.get(firstName.toUpperCase());
        }
        else firstCode = firstInitialCodeMap.get(String.valueOf(firstName.charAt(0)).toUpperCase());
        if (middleInitial.isEmpty()) return firstCode;
        else return firstCode + middleInitialCodeMap.get(String.valueOf(middleInitial.charAt(0)));
    }
}
